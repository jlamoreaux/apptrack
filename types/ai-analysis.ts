...
export type ErrorType = 'network' | 'auth' | 'server' | 'validation' | 'unknown'
...
export function isJobFitAnalysisResult(result: AnalysisResult): result is JobFitAnalysisResult {
  return 'overallScore' in result && 'scoreLabel' in result
}

export function isInterviewPreparationResult(result: AnalysisResult): result is InterviewPreparationResult {
  return 'questions' in result && Array.isArray((result as InterviewPreparationResult).questions)
}

export function isCoverLetterResult(result: AnalysisResult): result is CoverLetterResult {

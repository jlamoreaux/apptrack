...
export const metadata: Metadata = {
  ...
  description:
    "See your total comp, base plus bonus plus equity, projected year by year through your vest, up to five years out, and valued at the live stock price. No account needed to try it.",
  keywords: [
    "comp tracker",
  ...
  openGraph: {
    ...
    description:
      "Your total comp, projected through your vest, up to five years out, and valued at the live stock price.",
    url: canonicalUrl,

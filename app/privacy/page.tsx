  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl privacy-policy">
      <div data-custom-class="body">
        ...
        <div style={{lineHeight: 1.5}}><span style={{fontSize: '15px'}}><span data-custom-class="body_text">For the complete privacy policy, please contact us at <a href="mailto:support@apptrack.ing">support@apptrack.ing</a> or refer to our full policy document.</span></span></div>
        
        <div style={{lineHeight: 1.5}}><br /></div>
        
        <div style={{lineHeight: 1.5}}><span style={{fontSize: '15px'}}><span data-custom-class="body_text">If you have questions or comments about this notice, you may email us at <a target="_blank" data-custom-class="link" href="mailto:support@apptrack.ing">support@apptrack.ing</a> or contact us by post at:</span></span></div>
        
        <div style={{lineHeight: 1.5}}><br /></div>
        
        <div style={{lineHeight: 1.5}}><span style={{fontSize: '15px'}}><span data-custom-class="body_text">Jordan Lamoreaux<br />United States</span></span></div>
      </div>
    </div>
  )
}
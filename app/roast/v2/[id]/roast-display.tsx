...
export default function RoastDisplay({ roast, roastId, isCreator = false }: { roast: RoastData; roastId: string; isCreator?: boolean }) {
  ...
  const getScoreColor = (emojiScore: string) => {
    ...
    if (emojiScore.includes("🤨") || emojiScore.includes("😬")) return "text-amber-600";
    if (emojiScore.includes("🥱") || emojiScore.includes("🫤")) return "text-yellow-600";
    if (emojiScore.includes("🔥") || emojiScore.includes("🎪")) return "text-red-600";
          ...
          <Card className="p-8 bg-primary/5">
            {isCreator ? (
              <>
                ...
                <h2 className="text-2xl font-bold mb-4">Turn This Roast Into Results</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Get AI-powered resume fixes, custom cover letters for each job, and interview answers that actually land offers
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      router.push("/roast-my-resume/v2");
                    }}
                  >

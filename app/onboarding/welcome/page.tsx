...
import { Check, Sparkles, Zap, Trophy, ArrowRight, Gift, Star, Crown, Brain } from "lucide-react";
...
export default function OnboardingWelcomePage() {
  ...
  const handlePlanSelection = async (planName: string) => {
    ...
    if (planName === PLAN_NAMES.FREE) {
      ...
      if (plan) {
        router.push(`/dashboard/upgrade/checkout?planId=${planName.toLowerCase().replace(' ', '-')}&billingCycle=monthly`);
      }
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4 py-12">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">
                      🎊 Welcome Bonus: Get 20% off any paid plan for your first 3 months!
                    </p>
            ...
            >
              ...
              <CardHeader className="space-y-2 pb-4">
                <div className="flex items-center justify-between">
                  ...
                  {plan.name === PLAN_NAMES.PRO && <Crown className="h-5 w-5 text-yellow-500" />}
                  {plan.name === PLAN_NAMES.AI_COACH && <Brain className="h-5 w-5 text-purple-500" />}
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h2 className="text-2xl font-bold text-foreground">Why Choose a Paid Plan?</h2>
          
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg bg-card border border-border">
              <Zap className="h-8 w-8 text-yellow-500 mx-auto mb-2" />
              <h3 className="font-semibold text-foreground mb-1">Land Jobs Faster</h3>
              <p className="text-sm text-muted-foreground">
                Track unlimited applications and stay organized throughout your search
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-card border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                AI-powered tools help you craft winning resumes and ace interviews
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-card border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                Automated tracking and AI assistance means less busywork, more results
              </p>
            </div>
          </div>
